...
const mockLessons = [
  ...
  },
  {
    id: '6',
    title: 'Das Verb "sein"',
    description: 'Einführung in das wichtigste deutsche Verb',
    duration: 30,
    xpReward: 90,
    completed: false,
    locked: true,
      ...
      <main className="relative z-10 container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
            Начальный уровень немецкого языка. Изучите основы: алфавит, произношение, 
            базовую лексику и грамматические структуры
          </p>
