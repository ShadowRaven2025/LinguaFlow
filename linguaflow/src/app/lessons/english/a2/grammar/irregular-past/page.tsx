...
const slides: Slide[] = [
  {
    id: 1,
    type: 'theory',
    title: 'Irregular Past Tense - Неправильные глаголы в прошедшем времени',
    content: `
      <div class="space-y-6">
        <h2 class="text-2xl font-bold mb-4">Неправильные глаголы - исключения из правил</h2>
        
        <div class="bg-red-50 p-6 rounded-lg">
          <h3 class="text-lg font-semibold mb-3 text-red-700">Важно!</h3>
          <p class="text-lg">Неправильные глаголы <strong>НЕ</strong> образуют прошедшее время с помощью -ed</p>
          <p class="text-sm text-gray-600 mt-2">Их формы нужно запомнить наизусть</p>
        </div>
        
        <div class="grid md:grid-cols-2 gap-6">
          <div class="space-y-4">
            <h3 class="text-lg font-semibold text-blue-600">Самые частые неправильные глаголы</h3>
            <div class="space-y-3">
              <div class="flex justify-between items-center p-3 bg-blue-50 rounded">
                <span><strong>go</strong> → went</span>
                <span class="text-sm text-gray-600">идти</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-blue-50 rounded">
                <span><strong>come</strong> → came</span>
                <span class="text-sm text-gray-600">приходить</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-blue-50 rounded">
                <span><strong>see</strong> → saw</span>
                <span class="text-sm text-gray-600">видеть</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-blue-50 rounded">
                <span><strong>get</strong> → got</span>
                <span class="text-sm text-gray-600">получать</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-blue-50 rounded">
                <span><strong>make</strong> → made</span>
                <span class="text-sm text-gray-600">делать</span>
              </div>
            </div>
          </div>
          
          <div class="space-y-4">
            <h3 class="text-lg font-semibold text-green-600">Еще важные глаголы</h3>
            <div class="space-y-3">
              <div class="flex justify-between items-center p-3 bg-green-50 rounded">
                <span><strong>take</strong> → took</span>
                <span class="text-sm text-gray-600">брать</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-green-50 rounded">
                <span><strong>give</strong> → gave</span>
                <span class="text-sm text-gray-600">давать</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-green-50 rounded">
                <span><strong>have</strong> → had</span>
                <span class="text-sm text-gray-600">иметь</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-green-50 rounded">
                <span><strong>say</strong> → said</span>
                <span class="text-sm text-gray-600">говорить</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-green-50 rounded">
                <span><strong>do</strong> → did</span>
                <span class="text-sm text-gray-600">делать</span>
              </div>
            </div>
          </div>
        ...
        <div class="bg-yellow-50 p-4 rounded-lg">
          <h3 class="font-semibold mb-2">💡 Группы неправильных глаголов:</h3>
          <ul class="space-y-1 text-sm">
            <li>• <strong>Одинаковые формы:</strong> put → put, cut → cut</li>
            <li>• <strong>Изменение гласной:</strong> sing → sang, drink → drank</li>
            <li>• <strong>Полностью разные:</strong> go → went, buy → bought</li>
          </ul>
        </div>
      </div>
    `
  },
  {
    ...
    question: 'Как будет "go" в прошедшем времени?',
  ...
  },
  {
    ...
    question: 'Прошедшее время глагола "see":',
  ...
  },
  {
    id: 5,
    type: 'fill_gap',
    title: 'Вчерашние дела',
    question: 'Поставьте неправильные глаголы в прошедшее время:',
    fillText: 'Yesterday I ___ (go) to the store and ___ (buy) some food. Then I ___ (come) home and ___ (make) dinner. My friend ___ (give) me a call.',
    fillAnswers: ['went', 'bought', 'came', 'made', 'gave']
  },
  {
    id: 6,
    type: 'quiz_multiple',
    title: 'Найдите неправильные глаголы',
    question: 'Какие из этих форм прошедшего времени от неправильных глаголов?',
    options: ['walked', 'went', 'played', 'saw', 'worked', 'took', 'listened', 'came'],
    correctAnswer: [1, 3, 5, 7] // went, saw, took, came
  },
  {
    id: 7,
    type: 'quiz_single',
    title: 'Сложные случаи',
    question: 'Прошедшее время глагола "buy":',
    options: ['buyed', 'bought', 'byed', 'buied'],
    correctAnswer: 1
  },
  {
    id: 8,
    ...
    question: 'Завершите рассказ неправильными глаголами:',
    fillText: 'Last weekend I ___ (have) a great time. I ___ (go) to the park and ___ (see) my friends. We ___ (take) many photos and ___ (eat) ice cream.',
    fillAnswers: ['had', 'went', 'saw', 'took', 'ate']
  },
  {
    id: 9,
    type: 'theory',
    ...
    content: `
      <div class="text-center space-y-6">
        ...
        <p class="text-lg">Теперь вы знаете самые важные неправильные глаголы!</p>
        
        <div class="bg-green-50 p-6 rounded-lg">
          <h3 class="font-semibold mb-4">Что вы изучили:</h3>
          <ul class="text-left space-y-2">
            <li>✅ 10 самых частых неправильных глаголов</li>
            <li>✅ Группы неправильных глаголов</li>
            <li>✅ Использование в предложениях</li>
            <li>✅ Отличия от правильных глаголов</li>
          </ul>
        </div>
        
        <div class="bg-blue-50 p-4 rounded-lg">
          <h3 class="font-semibold mb-2">Совет для запоминания:</h3>
          <p class="text-sm">Учите неправильные глаголы группами и используйте их в предложениях!</p>
        </div>
...
export default function IrregularPastLesson() {
          ...
          <div className="space-y-6">
            ...
            {showFeedback[slide.id] && (
              <Alert variant={isCorrectAnswer(slide.id, userAnswers[slide.id]) ? "default" : "destructive"}>
                ...
                <AlertDescription>
                  {isCorrectAnswer(slide.id, userAnswers[slide.id]) 
                    ? "Правильно! Вы выбрали все неправильные глаголы!" 
                    : "Неправильные глаголы: went, saw, took, came"
                  }
                </AlertDescription>
              </Alert>
            )}
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="text-sm text-gray-600">
              Подсказка: используйте неправильные формы глаголов из урока
            </div>
            <Button 
            ...
            {showFeedback[slide.id] && (
              <Alert variant={isCorrectAnswer(slide.id, userAnswers[slide.id]) ? "default" : "destructive"}>
                ...
                <AlertDescription>
                  {isCorrectAnswer(slide.id, userAnswers[slide.id]) 
                    ? "Превосходно! Все неправильные глаголы в правильной форме!" 
      ...
      <div className="bg-white dark:bg-gray-800 border-b">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium">Irregular Past Tense</span>
