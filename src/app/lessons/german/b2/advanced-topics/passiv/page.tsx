...
const exercises: Array<{
...
}> = [
  {
    id: 1,
    type: 'quiz_single',
    question: 'Wie bildet man das Passiv Präsens?',
    options: [
      'wird + Partizip II',
      'wurde + Partizip II',
      'wird + Infinitiv',
    ...
    correct: 0,
    explanation: 'Präsens Passiv: wird + Partizip II (+ von + Agens).'
  },
  {
    id: 2,
    type: 'fill_gap',
    question: 'Das Buch ___ gerade ___ (lesen).',
    answer: 'wird gelesen',
    acceptableAnswers: ['wird gelesen'],
  ...
  },
  {
    ...
    options: [
      ...
      'Der Lehrer hat die Grammatik.',
      'Die Grammatik ist erklärt.'
    ],
    correct: 1,
    explanation: 'Die Grammatik wird erklärt = Subjekt empfängt die Handlung.'
  },
  {
    id: 4,
    type: 'fill_gap',
    question: 'Das Haus ___ gestern ___ (bauen).',
    answer: 'wurde gebaut',
    acceptableAnswers: ['wurde gebaut'],
    explanation: 'Präteritum Passiv: wurde + Partizip II.'
  },
  {
    id: 5,
    type: 'quiz_single',
    question: 'Was ist die Funktion des Passivs?',
    options: [
      'Die Handlung wird betont',
      'Der Handelnde (Agens) wird in den Vordergrund gestellt',
      'Die Zeit wird angegeben',
      'Die Meinung wird ausgedrückt'
    ],
    correct: 0,
    explanation: 'Passiv betont die Handlung, nicht den Handelnden.'
  }
]

export default function PassivLesson() {
      ...
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-primary" /><span className="font-semibold">Passiv</span></div>
          ...
          {!isComplete ? (
            <Card>
              <CardContent className="p-6">
                ...
                <h2 className="text-xl font-bold mb-4">Das Passiv</h2>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">Sie haben das Passiv beendet.</p>
