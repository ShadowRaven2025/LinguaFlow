...
const exercises: Array<{
...
}> = [
  {
    id: 1,
    type: 'quiz_single',
    question: 'Wählen Sie die richtige Konjunktiv II Form:',
    options: [
      'Ich wäre glücklich.',
      'Ich ware glücklich.',
      'Ich wird glücklich.',
    ...
    correct: 0,
    explanation: 'Konjunktiv II: wäre (von sein).'
  },
  {
    id: 2,
    type: 'fill_gap',
    question: 'Wenn ich mehr Zeit ___, würde ich mehr lesen.',
    answer: 'hätte',
    acceptableAnswers: ['hätte', 'hatte'],
    explanation: 'Konjunktiv II von haben: hätte.'
  },
  {
    id: 3,
    type: 'quiz_single',
    question: 'Konjunktiv II wird verwendet für:',
    options: [
      'Realität und Fakten',
      'Höfliche Bitten und irreale Wünsche',
      'Befehle',
      'Vergangene Ereignisse'
    ],
    correct: 1,
    explanation: 'Konjunktiv II = irreale, hypothetische Situationen, Höflichkeit.'
  },
  {
    id: 4,
    type: 'fill_gap',
    question: 'Ich ___ gerne in Berlin wohnen. (würde + infinitiv)',
    answer: 'würde gerne in Berlin wohnen',
    acceptableAnswers: ['würde gerne in Berlin wohnen'],
    explanation: 'Würde + Infinitiv für regelmäßige Verben.'
  },
  {
    id: 5,
    type: 'quiz_single',
    ...
    options: [
      'Wenn ich du wäre, ich würde helfen.',
      'Wenn ich du wäre, würde ich helfen.',
      'Wenn ich du wär, würde ich helfen.',
      'Wenn ich du sein, würde ich helfen.'
    ],
    correct: 1,
    explanation: 'Wenn-Satz mit Konjunktiv II, Hauptatz mit würde.'
  }
]

export default function KonjunktivIILesson() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 dark:from-slate-900 dark:to-slate-800">
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <Link href="/lessons/german/b2/advanced-topics">
              <Button variant="ghost" size="sm"><ArrowLeft className="w-4 h-4 mr-2" />B2 Themen</Button>
            </Link>
            <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-primary" /><span className="font-semibold">Konjunktiv II</span></div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground"><Clock className="w-4 h-4" /><span>20 min</span></div>
          </div>
        </div>
      </header>
          ...
          {!isComplete ? (
            <Card>
              <CardContent className="p-6">
                ...
                <h2 className="text-xl font-bold mb-4">Konjunktiv II</h2>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">Sie haben Konjunktiv II beendet.</p>
                ...
                <div className="flex gap-3">
                  <Link href="/lessons/german/b2/advanced-topics" className="flex-1">
                    <Button variant="outline" className="w-full">Zurück</Button>
                  </Link>
                  <Link href="/lessons/german/b2" className="flex-1">
