...
const exercises: Array<{
...
}> = [
  {
    id: 1,
    type: 'quiz_single',
    question: 'Was gehört NICHT in die Einleitung eines Aufsatzes?',
    options: [
    ...
    correct: 2,
    explanation: 'Die Schlussfolgerung kommt am Ende, nicht in der Einleitung.'
  },
  {
    id: 2,
    type: 'fill_gap',
    question: 'In diesem Aufsatz werde ich ___ und ___ darstellen.',
    answer: 'Pro und Contra',
    acceptableAnswers: ['Pro und Contra', 'Argumente für und gegen'],
    explanation: 'Typische Struktur für Erörterungen.'
  },
  {
    id: 3,
    type: 'quiz_single',
    question: 'Welches Wort ist ein typischer Übergangsausdruck?',
    options: [
      'Deshalb',
      'Außerdem',
      'Wegen',
    ...
    correct: 1,
    explanation: 'Außerdem = moreover/furthermore, ein Übergangsausdruck.'
  },
  {
    id: 4,
    type: 'fill_gap',
    question: '___ meiner Meinung nach ist das Thema sehr wichtig.',
    answer: 'Meiner',
    acceptableAnswers: ['Meiner'],
    explanation: 'Meiner Meinung nach = in my opinion.'
  },
  {
    id: 5,
    type: 'quiz_single',
    question: 'Was ist die correcte Reihenfolge?',
    options: [
      'Einleitung - Schluss - Hauptteil',
      'Einleitung - Hauptteil - Schluss',
      'Hauptteil - Einleitung - Schluss',
      'Schluss - Hauptteil - Einleitung'
    ],
    correct: 1,
    explanation: 'Klassische Struktur: Einleitung - Hauptteil - Schluss.'
  }
]

export default function AufsatzschreibenLesson() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-lime-50 to-green-100 dark:from-slate-900 dark:to-slate-800">
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <Link href="/lessons/german/b2/writing">
              <Button variant="ghost" size="sm"><ArrowLeft className="w-4 h-4 mr-2" />B2 Schreiben</Button>
            </Link>
            <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-primary" /><span className="font-semibold">Aufsatzschreiben</span></div>
          ...
          {!isComplete ? (
            <Card>
              <CardContent className="p-6">
                ...
                <h2 className="text-xl font-bold mb-4">Aufsatzschreiben</h2>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">Sie haben Aufsatzschreiben beendet.</p>
                ...
                <div className="flex gap-3">
                  <Link href="/lessons/german/b2/writing" className="flex-1">
