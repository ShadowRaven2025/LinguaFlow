...
import { BookOpen, Brain, Trophy, Clock, Star, ArrowLeft, Search, CheckCircle, Lock, Play, GraduationCap, Sparkles, Target, MessageCircle, Users, PenTool, Zap, Globe } from 'lucide-react'

const mockLessons = [
  {
    id: 'grammar-1',
    title: 'Advanced Tenses',
    description: 'Сложные времена: Future Continuous, Past Perfect Continuous',
    duration: 25,
    xpReward: 70,
    category: 'grammar'
  },
  {
    ...
    description: 'Модальные глаголы: must, have to, might, could, may',
    duration: 22,
    xpReward: 60,
    category: 'grammar'
  },
  {
    ...
    description: 'Страдательный залог в сложных конструкциях',
    duration: 20,
    xpReward: 55,
    category: 'grammar'
  },
  {
    ...
    description: 'Косвенная речь и согласование времен',
    duration: 25,
    xpReward: 70,
    category: 'grammar'
  },
  {
    ...
    description: 'Деловая переписка и коммуникация',
    duration: 20,
    xpReward: 55,
    category: 'vocabulary'
  },
  {
    ...
    description: 'Академическая и научная лексика',
    duration: 25,
    xpReward: 70,
    category: 'vocabulary'
  },
  {
    ...
    description: 'Идиомы и фразовые глаголы',
    duration: 30,
    xpReward: 80,
    category: 'vocabulary'
  },
  {
    id: 'vocab-4',
    title: 'News & Media',
    description: 'Лексика новостей и СМИ',
    duration: 20,
    xpReward: 55,
    category: 'vocabulary'
  },
  {
    ...
    description: 'Ведение дебатов и аргументация',
    duration: 25,
    xpReward: 70,
  ...
  },
  {
    id: 'conv-3',
    title: 'Negotiations',
    description: 'Переговоры и достижение соглашения',
    duration: 28,
    xpReward: 75,
    category: 'conversation'
  },
  {
    id: 'writing-1',
    title: 'Essay Writing',
    description: 'Написание эссе: структура и аргументация',
    duration: 35,
    xpReward: 90,
    category: 'writing'
  },
  {
    ...
    description: 'Официальные письма и заявления',
    duration: 25,
    xpReward: 70,
    category: 'writing'
  },
...
export default function EnglishB2Page() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('linguaflow-b2-progress')
    if (saved) {
      try {
  ...
  const getCorrectLessonPath = (lessonId: string, category: string) => {
    if (category === 'grammar') {
      return '/lessons/english/b2/advanced-grammar'
    }
    if (category === 'vocabulary') {
      return '/lessons/english/b2/vocabulary'
    }
    if (category === 'writing') {
      return '/lessons/english/b2/writing-skills'
    }
    return `/lessons/english/b2`
  }
          ...
          <nav className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Английский B2</div>
              </div>
            </Link>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Advanced Tenses</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Complex Modal Verbs</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Reported Speech</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Passive Voice Advanced</li>
                </ul>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Business English</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Academic Writing</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Idioms & Phrasal Verbs</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Debates & Presentations</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-3 gap-4">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-sm">Upper Intermediate</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2">
                    <Badge className="bg-blue-500/10 text-blue-500">B2</Badge>
            ...
            <Link href="/lessons/english-grammar-in-use">
              <Card className="group border-border/50 hover:border-primary/30 transition-all duration-300 card-hover opacity-0 animate-in-up" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
                ...
                <CardContent>
                  <div className="flex items-center gap-2">
                    <Badge className="bg-purple-500/10 text-purple-500">B2</Badge>
            ...
            <Link href="/lessons/english-file/upper-intermediate">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-sm">English File</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2">
                    <Badge className="bg-green-500/10 text-green-500">B2</Badge>
                    <span className="text-xs text-muted-foreground">6 модулей</span>
                  </div>
                </CardContent>
              </Card>
            </Link>
