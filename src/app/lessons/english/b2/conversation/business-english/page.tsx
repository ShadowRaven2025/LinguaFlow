...
const exercises: Array<{
...
}> = [
  {
    id: 1,
    type: 'quiz_single',
    question: 'Choose the correct phrase for a business email opening:',
    options: [
      'Hey there, what\'s up?',
    ...
    correct: 1,
    explanation: 'Professional email opening: "I hope this email finds you well."'
  },
  {
    id: 2,
    type: 'fill_gap',
    question: 'Please find the attached ___ for your review.',
    answer: 'document',
    acceptableAnswers: ['document', 'report', 'file'],
    explanation: 'Formal phrase: Please find attached...'
  },
  {
    id: 3,
    type: 'quiz_single',
    question: 'Which is the most formal way to say "I need this done quickly"?',
    options: [
      'Hurry up!',
      'I would appreciate it if you could expedite this matter.',
      'Can you do it fast?',
      ' ASAP please!'
    ],
    correct: 1,
    explanation: 'Formal business English uses indirect requests.'
  },
  {
    id: 4,
    type: 'fill_gap',
    question: 'I am writing to ___ your proposal.',
    answer: 'follow up on',
    acceptableAnswers: ['follow up on', 'follow-up on'],
    explanation: 'Follow up on = take action regarding something.'
  },
  {
    id: 5,
    type: 'quiz_single',
    question: 'Choose the correct formal closing:',
    options: [
      'Later!',
      'Best regards',
      'XOXO',
...
export default function BusinessEnglishLesson() {
      ...
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <Link href="/lessons/english/b2/conversation">
              <Button variant="ghost" size="sm"><ArrowLeft className="w-4 h-4 mr-2" />B2 Conversation</Button>
            </Link>
            <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-primary" /><span className="font-semibold">Business English</span></div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground"><Clock className="w-4 h-4" /><span>22 min</span></div>
          </div>
        </div>
      </header>
          ...
          {!isComplete ? (
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">You have finished Business English.</p>
                ...
                <div className="flex gap-3">
                  <Link href="/lessons/english/b2/conversation" className="flex-1">
                    <Button variant="outline" className="w-full">Back to Conversation</Button>
                  </Link>
