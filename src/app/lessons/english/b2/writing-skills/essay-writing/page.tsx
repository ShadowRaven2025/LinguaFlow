...
const exercises: Array<{
...
}> = [
  {
    id: 1,
    type: 'quiz_single',
    question: 'What is the correct essay structure?',
    options: [
    ...
    correct: 0,
    explanation: 'Standard essay structure: Introduction, Body Paragraphs, Conclusion.'
  },
  {
    id: 2,
    type: 'fill_gap',
    question: 'In ___ paragraph, you present your thesis statement.',
    answer: 'introductory',
    acceptableAnswers: ['introductory', 'introduction', 'first'],
    explanation: 'The introductory paragraph contains the thesis.'
  },
  {
    id: 3,
    type: 'quiz_single',
    question: 'Which linking word is used to show contrast?',
    options: [
      'Furthermore',
      'However',
      'Therefore',
    ...
    correct: 1,
    explanation: 'However shows contrast/opposition between ideas.'
  },
  {
    id: 4,
    type: 'fill_gap',
    question: '___ addition, the study showed significant improvements.',
    answer: 'In',
    acceptableAnswers: ['In'],
    explanation: 'In addition = moreover/furthermore.'
  },
  {
    id: 5,
    type: 'quiz_single',
    ...
    options: [
      'State a fact that everyone agrees with',
      'Present a debatable argument',
      'Be as long as possible',
      'List all main points'
    ],
    correct: 1,
    explanation: 'A thesis presents an arguable position, not a fact.'
  }
]
      ...
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <Link href="/lessons/english/b2/writing-skills">
              <Button variant="ghost" size="sm"><ArrowLeft className="w-4 h-4 mr-2" />B2 Writing</Button>
            </Link>
            <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-primary" /><span className="font-semibold">Essay Writing</span></div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground"><Clock className="w-4 h-4" /><span>28 min</span></div>
          </div>
        </div>
      </header>
          ...
          {!isComplete ? (
            <Card>
              <CardContent className="p-6">
                ...
                <h2 className="text-xl font-bold mb-4">Essay Writing</h2>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">You have finished Essay Writing.</p>
                ...
                <div className="flex gap-3">
                  <Link href="/lessons/english/b2/writing-skills" className="flex-1">
                    <Button variant="outline" className="w-full">Back to Writing</Button>
                  </Link>
