...
const exercises: Array<{
...
}> = [
  {
    ...
    options: [
      ...
      'The report were written by the manager.',
      'The report is wrote by the manager.',
      'The report was write by the manager.'
    ],
    correct: 0,
    explanation: 'Past Simple Passive: Subject + was/were + Past Participle.'
  },
  {
    id: 2,
    type: 'fill_gap',
    question: 'The meeting ___ (hold) tomorrow. (by the team)',
    answer: 'will be held',
    acceptableAnswers: ['will be held', 'shall be held'],
  ...
  },
  {
    ...
    correct: 1,
    explanation: 'The letter was written by her - subject receives the action.'
  },
  {
    id: 4,
    type: 'fill_gap',
    ...
    answer: 'is spoken',
    acceptableAnswers: ['is spoken', 'speaks'],
    explanation: 'Present Simple Passive for general truths.'
  },
  {
    id: 5,
    type: 'quiz_single',
    question: 'Complete: The building ___ when the fire ___',
    options: [
      'was evacuating / started',
      'was evacuated / started',
      'evacuated / was starting',
      'had evacuated / was starting'
    ],
    correct: 1,
    explanation: 'was + Past Participle (evacuated). Two passive forms needed.'
  }
]
      ...
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2"><BookOpen className="w-5 h-5 text-primary" /><span className="font-semibold">Passive Voice</span></div>
          ...
          {!isComplete ? (
            <Card>
              <CardContent className="p-6">
                ...
                <h2 className="text-xl font-bold mb-4">Passive Voice</h2>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">You have finished Passive Voice.</p>
