...
const slides: Slide[] = [
      ...
      sections: [
        {
          ...
          examples: [
            { word: 'My name is...', translation: 'Меня зовут...', emoji: '👋' },
        ...
        },
        {
          ...
          examples: [
            { word: 'What is your name?', translation: 'Как тебя зовут?', emoji: '❓' },
            { word: 'Where are you from?', translation: 'Откуда ты?', emoji: '🌍' },
            { word: 'How old are you?', translation: 'Сколько тебе лет?', emoji: '🎂' }
          ]
        }
      ]
    }
  ...
  },
  {
    ...
    options: ['Как дела?', 'Приятно познакомиться', 'Откуда ты?', 'Меня зовут'],
    correctAnswer: 1
  },
  {
    id: 4,
    ...
    pairs: [
      ...
      { left: 'Where are you from?', right: 'Откуда ты?' },
  ...
  },
  {
    ...
    question: 'Fill in the blanks to complete the introduction:',
    fillText: 'Hello! ___ name is Anna. I ___ from Russia. ___ to meet you!',
    fillAnswers: ['My', 'am', 'Nice']
  },
  {
    id: 6,
    type: 'quiz_multiple',
    title: 'Introduction Phrases',
    question: 'Which phrases are used for introducing yourself?',
    options: ['My name is...', 'Where are you from?', 'I am...', 'How old are you?', 'Nice to meet you'],
    correctAnswer: [0, 2, 4]
  },
  {
    id: 7,
...
export default function MyNameIsLesson() {
        ...
        if (slide.content.completion) {
          return (
            <div className="text-center space-y-6">
              ...
              <p className="text-xl text-white/80 dark:text-white/80">You've learned how to introduce yourself!</p>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-slate-600 dark:text-white/80">Learn how to introduce yourself in English</p>
            </div>
            
            {slide.content.sections?.map((section: any, sectionIndex: number) => (
              <div key={sectionIndex} className="space-y-4">
                <h3 className="text-xl font-semibold text-pink-600 dark:text-pink-400">{section.subtitle}</h3>
            ...
            {showFeedback[slide.id] && (
              <div className={`p-4 rounded-xl border ${
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {isCorrectAnswer(slide.id, userAnswers[slide.id]) 
                      ? "Perfect! You selected all introduction phrases!" 
                      : "Try again. Introduction phrases are: My name is..., I am..., Nice to meet you"
                    }
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <h4 className="font-medium text-pink-600 dark:text-pink-400">English</h4>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="text-sm text-slate-600 dark:text-white/60">
              Hint: Use introduction phrases from the lesson (My, am, Nice)
            </div>
            <Button 
            ...
            {showFeedback[slide.id] && (
              <div className={`p-4 rounded-xl border ${
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {isCorrectAnswer(slide.id, userAnswers[slide.id]) 
                      ? "Perfect! Your dialogue is complete!" 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-pink-50 to-slate-50 dark:from-slate-900 dark:via-pink-900 dark:to-slate-900 text-slate-900 dark:text-white">
      {/* Header */}
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <div className="text-sm text-slate-600 dark:text-white/60 mb-1">Урок 10</div>
              <h1 className="text-3xl font-bold">My Name Is...</h1>
              <p className="text-slate-600 dark:text-white/80">Learn how to introduce yourself</p>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-2xl font-bold text-pink-600 dark:text-pink-400">{progress}%</span>
            </div>
