...
import { BookOpen, Play, Clock, Star, ArrowLeft, CheckCircle, XCircle, Shirt } from 'lucide-react'
...
const slides: Slide[] = [
      ...
      sections: [
        {
          subtitle: 'Tops',
          examples: [
            { word: 'shirt', translation: 'рубашка', emoji: '👔' },
            { word: 'T-shirt', translation: 'футболка', emoji: '👕' },
            { word: 'jacket', translation: 'куртка', emoji: '🧥' },
            { word: 'sweater', translation: 'свитер', emoji: '🧶' }
          ]
        },
        {
          subtitle: 'Bottoms',
          examples: [
            { word: 'pants / trousers', translation: 'брюки', emoji: '👖' },
            { word: 'shorts', translation: 'шорты', emoji: '🩳' },
            { word: 'skirt', translation: 'юбка', emoji: '👗' }
          ]
        },
        {
          subtitle: 'Footwear',
          examples: [
            { word: 'shoes', translation: 'туфли', emoji: '👞' },
            { word: 'boots', translation: 'ботинки', emoji: '👢' },
            { word: 'sneakers', translation: 'кроссовки', emoji: '👟' }
          ]
        },
        {
          subtitle: 'Accessories',
          examples: [
            { word: 'hat', translation: 'шляпа', emoji: '🎩' },
            { word: 'cap', translation: 'кепка', emoji: '🧢' },
            { word: 'gloves', translation: 'перчатки', emoji: '🧤' }
          ]
        }
      ]
    }
  },
  {
    ...
    options: ['shirt', 'shoes', 'hat', 'jacket'],
    correctAnswer: 1
  },
  {
    id: 3,
    ...
    options: ['shorts', 'T-shirt', 'sweater', 'skirt'],
    correctAnswer: 2
  },
  {
    id: 4,
    type: 'match',
    title: 'Match Clothes',
    question: 'Match clothing items with where you wear them:',
    pairs: [
      { left: 'shoes', right: 'feet' },
      { left: 'hat', right: 'head' },
      { left: 'gloves', right: 'hands' },
      { left: 'jacket', right: 'body' }
    ]
  },
  {
    id: 5,
    type: 'fill_gap',
    title: 'My Outfit',
    question: 'Describe your favorite outfit:',
    fillText: 'Today I am wearing a blue ___ and black ___. On my feet I have my comfortable ___.',
    fillAnswers: ['shirt', 'pants', 'shoes']
  },
  {
    id: 6,
    type: 'quiz_multiple',
    title: 'Accessories',
    question: 'Which items are accessories?',
    options: ['shoes', 'hat', 'shirt', 'gloves', 'pants', 'cap'],
    correctAnswer: [1, 3, 5]
  },
  {
    id: 7,
...
export default function BasicClothesLesson() {
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-white/80">Learn the names of different clothing items</p>
            </div>
              ...
              <div className={`p-4 rounded-xl border ${
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {isCorrectAnswer(slide.id, userAnswers[slide.id]) 
                      ? "Correct!" 
                      : `Wrong. The answer is: ${slide.options?.[slide.correctAnswer as number]}`
                    }
                  </span>
                </div>
              </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                <h4 className="font-medium text-green-400">Body Part</h4>
                {slide.pairs?.map((pair, index) => (
      ...
      <header className="bg-slate-800/50 backdrop-blur-sm border-b border-slate-700/50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/lessons/english/a1/clothes" className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-4">
              <ThemeToggle />
              <Link href="/lessons/english/a1/clothes">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold">Basic Clothes</h1>
              <p className="text-white/80">Learn names of common clothing items</p>
            </div>
          </div>
