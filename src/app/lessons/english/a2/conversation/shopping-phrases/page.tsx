...
const slides: Slide[] = [
  {
    ...
    content: {
      title: 'Фразы для покупок',
      sections: [
        {
          subtitle: 'Asking about items',
          examples: [
            { word: 'How much is this?', translation: 'Сколько это стоит?' },
            { word: 'Do you have this in another size?', translation: 'У вас есть другой размер?' },
            { word: 'Can I try this on?', translation: 'Можно примерить?' },
            { word: 'Where are the fitting rooms?', translation: 'Где примерочные?' }
          ]
        },
        {
          subtitle: 'Making purchases',
          examples: [
            { word: "I'll take it.", translation: 'Я возьму это.' },
            { word: 'Can I pay by card?', translation: 'Можно оплатить картой?' },
            { word: 'Do you have a bag?', translation: 'У вас есть пакет?' }
          ]
        }
      ]
    }
      ...
      sections: [
        {
          ...
          examples: [
            ...
            { word: 'trousers / pants', translation: 'брюки' },
            { word: 'dress', translation: 'платье' },
            { word: 'jacket', translation: 'пиджак / куртка' },
  ...
  },
  {
    ...
    question: 'How do you say you want to buy something?',
    options: [
      'How much is it?',
      "I'll take it.",
      'Where is the shop?',
  ...
  },
  {
    ...
    question: 'Match English with Russian:',
    pairs: [
      { left: 'dress', right: 'платье' },
      { left: 'shirt', right: 'рубашка' },
      { left: 'shoes', right: 'туфли' },
      { left: 'jacket', right: 'пиджак' }
    ]
  },
  {
    id: 6,
    type: 'quiz_single',
    title: 'Size question',
    question: 'How do you ask for a different size?',
    options: [
      'How much is this?',
  ...
  },
  {
    ...
    type: 'quiz_single',
    title: 'Vocabulary',
    question: '"Trousers" is another word for...',
    options: ['dress', 'shirt', 'pants', 'jacket'],
    correctAnswer: 2
  },
  {
    id: 8,
...
export default function ShoppingPhrasesLesson() {
  ...
  useEffect(() => { window.dispatchEvent(new CustomEvent('lessonProgressUpdate', { detail: { lessonId: 'a2-9', progress, completed: currentSlide === slides.length - 1 } })) }, [currentSlide, progress])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      <header className="bg-slate-800/50 backdrop-blur-sm border-b border-slate-700/50"><div className="container mx-auto px-4 py-4"><div className="flex items-center justify-between"><Link href="/lessons/english/a2" className="flex items-center space-x-2"><div className="w-10 h-10 bg-purple-600 rounded-xl flex items-center justify-center"><BookOpen className="w-6 h-6 text-white" /></div><span className="text-2xl font-bold">LinguaFlow</span></Link><div className="flex items-center space-x-4"><ThemeToggle /><Link href="/lessons/english/a2/conversation"><Button variant="outline" className="border-slate-600 hover:bg-slate-700"><ArrowLeft className="w-4 h-4 mr-2" />Back</Button></Link></div></div></div></header>
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto mb-8"><div className="flex items-center gap-4 mb-6"><div className="w-16 h-16 bg-purple-600 rounded-2xl flex items-center justify-center"><BookOpen className="w-8 h-8 text-white" /></div><div><div className="text-sm text-white/60 mb-1">Урок 9 • Conversation</div><h1 className="text-3xl font-bold">Shopping Phrases</h1><p className="text-white/80">Фразы для покупок</p></div></div><div className="mb-6"><div className="flex items-center justify-between mb-2"><span className="text-sm text-white/60">Progress</span><span className="text-2xl font-bold text-purple-400">{progress}%</span></div><div className="w-full bg-slate-800 rounded-full h-3"><div className="bg-gradient-to-r from-purple-500 to-purple-600 h-3 rounded-full transition-all duration-300" style={{ width: `${progress}%` }}></div></div></div><div className="flex items-center gap-6 text-sm text-white/60"><div className="flex items-center gap-2"><Clock className="w-4 h-4" /><span>20 min</span></div><div className="flex items-center gap-2"><Star className="w-4 h-4 text-yellow-400" /><span>50 XP</span></div></div></div>
