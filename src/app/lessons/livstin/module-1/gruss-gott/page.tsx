...
import { ArrowLeft, BookOpen, Play, Clock, Zap, CheckCircle, ArrowRight, Hand } from 'lucide-react'
...
const slides: Slide[] = [
  {
    id: 1,
    type: 'theory',
    title: 'Приветствия в немецком',
    content: {
      sections: [
        {
          subtitle: 'Официальные приветствия',
          examples: [
            { word: 'Guten Morgen', translation: 'Доброе утро', emoji: '🌅' },
            { word: 'Guten Tag', translation: 'Добрый день', emoji: '☀️' },
            { word: 'Guten Abend', translation: 'Добрый вечер', emoji: '🌙' },
            { word: 'Grüß Gott', translation: 'Привет (юг Германии, Австрия)', emoji: '🙋' }
          ]
        },
        {
          subtitle: 'Неформальные приветствия',
          examples: [
            { word: 'Hallo', translation: 'Привет', emoji: '👋' },
            { word: 'Hi', translation: 'Привет', emoji: '👋' },
            { word: 'Moin', translation: 'Привет (север Германии)', emoji: '🌊' },
            { word: 'Tschüss', translation: 'Пока', emoji: '👋' },
            { word: 'Ciao', translation: 'Пока (молодёжь)', emoji: '✌️' }
          ]
        },
        {
          subtitle: 'Как дела?',
          examples: [
            { word: 'Wie geht es Ihnen?', translation: 'Как Вы поживаете? (formal)', emoji: '🤔' },
            { word: 'Wie geht\'s?', translation: 'Как дела?', emoji: '😊' },
            { word: 'Alles gut?', translation: 'Всё хорошо?', emoji: '👍' }
          ]
        }
      ]
    }
  },
  {
    id: 2,
    type: 'quiz_single',
    title: 'Тест на приветствия',
    question: 'Какое приветствие используется в южной Германии и Австрии?',
    options: ['Hallo', 'Moin', 'Grüß Gott', 'Tschüss'],
    correctAnswer: 2,
    explanation: 'Grüß Gott - традиционное приветствие в Баварии, Австрии и южных регионах Германии.'
  },
  {
    id: 3,
    type: 'quiz_single',
    title: 'Тест на приветствия',
    question: 'Как сказать "Добрый день" официально?',
    options: ['Hallo', 'Guten Tag', 'Moin', 'Tschüss'],
    correctAnswer: 1,
    explanation: 'Guten Tag - нейтральное официальное приветствие в течение дня.'
  },
  {
    id: 4,
    type: 'match',
    title: 'Соответствия',
    question: 'Сопоставьте приветствия с их значением:',
    pairs: [
      { left: 'Guten Morgen', right: 'Доброе утро' },
      { left: 'Guten Abend', right: 'Добрый вечер' },
      { left: 'Tschüss', right: 'Пока' },
      { left: 'Wie geht\'s?', right: 'Как дела?' }
    ]
  },
  {
    id: 5,
    type: 'quiz_multiple',
    title: 'Выберите неформальные приветствия',
    question: 'Какие из этих приветствий неформальные?',
    options: ['Guten Tag', 'Hallo', 'Moin', 'Grüß Gott', 'Hi', 'Tschüss'],
    correctAnswer: [1, 2, 4]
  },
  {
    id: 6,
...
export default function GrussGottLesson() {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="text-green-400 font-medium">Модуль 1 - Урок 2</div>
              <h1 className="text-3xl font-bold text-white mb-2">Grüß Gott!</h1>
              <p className="text-white/80">Приветствия на немецком</p>
            </div>
          </div>
          ...
          <CardContent className="space-y-6">
            ...
            {slide.type === 'completion' && (
              <div className="text-center space-y-6">
                ...
                <p className="text-xl text-white/80">You've learned German greetings!</p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <h4 className="font-medium text-green-400">German</h4>
