...
const modules = [
  {
    ...
    lessons: ['Begrüßung', 'Sich vorstellen', 'Personalpronomen'],
  ...
  },
  {
    id: 2,
    title: 'Leute',
    description: 'Люди вокруг нас',
    lessons: ['Familie', 'Freunde', 'Kontakte'],
  ...
  },
  {
    ...
    lessons: ['Wohnung', 'Zimmer', 'Einrichtung'],
  ...
  },
  {
    ...
    lessons: ['Lebensmittel', 'Im Supermarkt', 'Kochen'],
  ...
  },
  {
    ...
    lessons: ['Berufe', 'Bewerbung', 'Im Büro'],
    color: 'from-yellow-500 to-orange-500',
    progress: 0
  }
]

export default function MenschenPage() {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/lessons/german-courses" className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-white hover:text-green-300 transition-colors">LinguaFlow</h1>
            </Link>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="text-green-400 font-medium">Menschen</div>
              <h1 className="text-3xl font-bold text-white mb-2">Коммуникативный курс</h1>
              <p className="text-white/80">Уровень A1-B1</p>
            </div>
          </div>
          ...
          {modules.map((module) => (
            <Card key={module.id} className="bg-slate-800/50 border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/80 transition-all duration-300">
              <CardContent className="p-0">
                <Link href={`/lessons/menschen/module-${module.id}`} className="block">
                  <div className="p-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
