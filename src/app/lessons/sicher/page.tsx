...
const modules = [
  {
    id: 1,
    title: 'Gesellschaft',
    description: 'Общество и люди',
    lessons: ['Lebenswelten', 'Zusammenleben', 'Generationen'],
  ...
  },
  {
    id: 2,
    title: 'Arbeitswelt',
    description: 'Рабочий мир',
    lessons: ['Bewerbung', 'Karriere', 'Arbeitsbedingungen'],
  ...
  },
  {
    id: 3,
    title: 'Medien',
    description: 'СМИ и технологии',
    lessons: ['Internet', 'Soziale Netzwerke', 'Nachrichten'],
  ...
  },
  {
    id: 4,
    title: 'Reisen',
    description: 'Путешествия и культура',
    lessons: ['Urlaub', 'Kultur', 'Sehenswürdigkeiten'],
  ...
  },
  {
    id: 5,
    title: 'Wissenschaft',
    description: 'Наука и исследования',
    lessons: ['Forschung', 'Entdeckungen', 'Innovationen'],
  ...
  },
  {
    ...
    lessons: ['Klima', 'Nachhaltigkeit', 'Umweltschutz'],
    color: 'from-yellow-500 to-amber-500',
    progress: 0
  }
]

export default function SicherPage() {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="text-purple-400 font-medium">Sicher!</div>
              <h1 className="text-3xl font-bold text-white mb-2">Продвинутый курс</h1>
              <p className="text-white/80">Уровень B1-C1</p>
            </div>
          </div>
          ...
          {modules.map((module) => (
            <Card key={module.id} className="bg-slate-800/50 border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/80 transition-all duration-300">
              <CardContent className="p-0">
                <Link href={`/lessons/sicher/module-${module.id}`} className="block">
                  <div className="p-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
